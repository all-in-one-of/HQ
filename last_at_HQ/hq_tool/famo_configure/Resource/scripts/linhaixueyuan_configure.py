...
class finishbar(QtGui.QWidget):
    def __init__(self):
        ...
        self.initUI()
    def initUI(self):
        self.win=QtGui.QMessageBox.about(self, u'Famo configure', u"MAYA2015林海雪原配置已完成！！    ")
HQ_tool(). initsetup()
HQ_tool(). updateVer(r"O:\hq_tool\famo_configure\modules\famo_configure_linhaixueyuan.mod")
import sys
