...
xuefeng.menu("Nuke").addCommand("Render/Render", "xuefeng.tcl('set nodes [nodes]; catch {set nodes [selected_nodes]}; render $nodes')", "alt+F5", index=2)
...
#size = xuefeng.numvalue("preferences.toolbarTextSize")



# Get the top-level toolbar

toolbar = xuefeng.menu("Nodes")



n = xuefeng.toolbar("Nodes")
...
m.addCommand("batchReads","Xuefeng.batchReads()")
...
n.addCommand("X_FilmGrain","xuefeng.createNode(\"X_FilmGrain\")",icon="X_plugins.png")
...
n.addCommand("He_RGBlayer","xuefeng.createNode(\"He_RGBlayer\")",icon="X_plugins.png")

n.addCommand("X_LgtPassRGB","xuefeng.createNode(\"X_LgtPassRGB\")",icon="X_plugins.png")

m.addCommand("RGB_to_alpha","xuefeng.createNode(\"RGB_to_alpha\")")
...
n.addCommand("X_nanPixels","xuefeng.createNode(\"X_nanPixels\")",icon="X_plugins.png")

n.addCommand("X_Slate","xuefeng.createNode(\"X_Slate\")",icon="X_plugins.png")

n.addCommand("X_SlateCAR","xuefeng.createNode(\"X_Slate_CAR-4\")",icon="X_plugins.png")

n.addCommand("X_WaterMarks","xuefeng.createNode(\"X_WaterMarks2\")",icon="X_plugins.png")

n.addCommand("X_WaterMarksCAR_Tga","xuefeng.createNode(\"X_WaterMarksCAR-2\")",icon="X_plugins.png")

n.addCommand("X_WaterMarksCAR_Dpx","xuefeng.createNode(\"X_WaterMarksCAR-3_Dpx\")",icon="X_plugins.png")

n.addCommand("X_WaterMarks_PRV","xuefeng.createNode(\"X_WaterMarks_prv2\")",icon="X_plugins.png")



n.addCommand("X_AspectRatioMark","xuefeng.createNode(\"X_AspectRatioMark\")",icon="X_plugins.png")

n.addCommand("X_Cropping","xuefeng.createNode(\"X_Cropping_v02\")")
...
n.addCommand("X_IDmsk","xuefeng.createNode(\"X_IDmsk\")",icon="X_plugins.png")

n.addCommand("X_LgtComp","xuefeng.createNode(\"X_LgtComp\")",icon="X_plugins.png")

n.addCommand("X_RoundLgt","xuefeng.createNode(\"X_RoundLgt\")",icon="X_plugins.png")
...
n.addCommand("X_RelightX","xuefeng.createNode(\"X_RelightX\")",icon="X_plugins.png")

n.addCommand("X_Stereo3DcamRig","xuefeng.createNode(\"X_Stereo3DcamRig\")",icon="X_plugins.png")

n.addCommand("X_Stereo3Dglasses","xuefeng.createNode(\"X_Stereo3Dglasses\")",icon="X_plugins.png")

n.addCommand("X_stereo3DprojectorFanta","xuefeng.createNode(\"X_stereo3DprojectorFanta\")",icon="X_plugins.png")

n.addCommand("X_stereo_camera","xuefeng.createNode(\"X_stereo_camera\")",icon="X_plugins.png")

n.addCommand("X_stereo_camera_v02","xuefeng.createNode(\"X_stereo_camera_v02\")",icon="X_plugins.png")

m.addCommand("LRview","xuefeng.createNode(\"LRview\")",icon="JoinViews.png")
...
m.addCommand( "VideoCopilot/OpticalFlares", "xuefeng.createNode('OpticalFlares')", icon="OpticalFlares.png")

m.addCommand("StarProNK","xuefeng.createNode(\"StarProNK\")")
...
m.addCommand("i_Slate","xuefeng.createNode(\"i_Slate\")")

m.addCommand("i_WaterMark","xuefeng.createNode(\"i_WaterMark\")")

m.addCommand("i_One","xuefeng.createNode(\"i_One\")")

m.addCommand("HeatHaze","xuefeng.createNode(\"HeatHaze\")")

m.addCommand("slate","xuefeng.createNode(\"slate\")")

m.addCommand("X_Sharpen","xuefeng.createNode(\"X_Sharpen\")")

m.addCommand("id","xuefeng.createNode(\"id\")")

m.addCommand("seven_viewer","xuefeng.createNode(\"seven_viewer\")")

m.addCommand("X_pingmuzhuanhuan","xuefeng.createNode(\"X_pingmuzhuanhuan\")")

m.addCommand("X_huanmu","xuefeng.createNode(\"X_huanmu\")")

m.addCommand("X_RenderBoth","xuefeng.createNode(\"X_RenderBoth\")")

m.addCommand("X_shadow3D","xuefeng.createNode(\"X_shadow3D\")")

m.addCommand("X_meter","xuefeng.createNode(\"X_meter\")")

m.addCommand("jumu_viewer_cg","xuefeng.createNode(\"jumu_viewer_cg\")")

m.addCommand("jumu_viewer_shipai","xuefeng.createNode(\"jumu_viewer_shipai\")")

m.addCommand("X_360zhuanping","xuefeng.createNode(\"X_360zhuanping\")")

m.addCommand("X_pingmu180","xuefeng.createNode(\"X_pingmu180\")")

m.addCommand("X_pingmu180_v01","xuefeng.createNode(\"X_pingmu180_v01\")")

m.addCommand("X_pingmu180_v02","xuefeng.createNode(\"X_pingmu180_v02\")")

m.addCommand("X_pingmu360","xuefeng.createNode(\"X_pingmu360\")")

m.addCommand("X_pingmu360_v01","xuefeng.createNode(\"X_pingmu360_v01\")")

m.addCommand("Huan_360_6P","xuefeng.createNode(\"Huan_360_6P\")")

m.addCommand("Huan_360_zhuan","xuefeng.createNode(\"Huan_360_zhuan\")")

m.addCommand("Huan_Cam_text","xuefeng.createNode(\"Huan_Cam_text\")")

m.addCommand("Randomizer","xuefeng.createNode(\"Randomizer\")")

m.addCommand("H_Normal_Light","xuefeng.createNode(\"H_Normal_Light\")")

m.addCommand("H_ScreensMerge","xuefeng.createNode(\"H_ScreensMerge\")")

m.addCommand("H_SixScreenMask","xuefeng.createNode(\"H_SixScreenMask\")")

m.addCommand("H_VectorBlur","xuefeng.createNode(\"H_VectorBlur\")")

m.addCommand("H_VectorBlur_FixVector","xuefeng.createNode(\"H_VectorBlur_FixVector\")")

m.addCommand("dk_hair_keyer","xuefeng.createNode(\"dk_hair_keyer\")")

m.addCommand("akromatism_stRub","xuefeng.createNode(\"akromatism_stRub\")")

m.addCommand("Bezier", "xuefeng.createNode(\"Bezier\")","p", icon="Bezier.png")

m.addCommand("H_EdgeFX","xuefeng.createNode(\"H_EdgeFX\")")

m.addCommand("H_IBlur","xuefeng.createNode(\"H_IBlur\")")

m.addCommand("H_Maskingwide","xuefeng.createNode(\"H_Maskingwide\")")

m.addCommand("Paint", "xuefeng.createNode(\"Paint\")", icon="Paint.png")

m.addCommand("X_ColorSpill","xuefeng.createNode(\"X_ColorSpill\")")

m.addCommand("X_ball_jiaozheng_v01","xuefeng.createNode(\"X_ball_jiaozheng_v01\")")

m.addCommand("VR","xuefeng.createNode(\"VR\")")

m.addCommand("X_AutoFlare","xuefeng.createNode(\"X_AutoFlare\")")

m.addCommand("Draw/FlareFactory Plus", "xuefeng.createNode(\"FlareFactory_Plus\")", icon="FlareFactoryPlus.png")

m.addCommand("RotateNomals", "xuefeng.createNode(\"RotateNomals\")")

m.addCommand("Track_move", "xuefeng.createNode(\"Track_move\")")

m.addCommand("watermasks", "xuefeng.createNode(\"watermasks\")")

m.addCommand("PFBarrel", "xuefeng.createNode(\"PFBarrel\")")
...
toolbar.addCommand("FXXF/JZ/FHCQ_Canon15mm_JZ","xuefeng.createNode('FHCQ_Canon15mm_JZ')")

toolbar.addCommand("FXXF/JZ/FHCQ_Noffset_JZ","xuefeng.createNode('FHCQ_Noffset_JZ')")

toolbar.addCommand("FXXF/JZ/FHCQ_Offset_JZ","xuefeng.createNode('FHCQ_Offset_JZ')")

toolbar.addCommand("FXXF/JZ/FHCQ_UV_jz","xuefeng.createNode('FHCQ_UV_jz')")

toolbar.addCommand("FXXF/JZ/FHCQ_six_to_one","xuefeng.createNode('FHCQ_six_to_one')")

#toolbar.addCommand("FXXF/JZ/Noffset_test","xuefeng.createNode('Noffset_test')")

m.addCommand("Voxel/V_Average",           "xuefeng.createNode('V_Average.gizmo')",   icon="V_Average.png")
m.addCommand("Voxel/V_Erode",             "xuefeng.createNode('V_Erode.gizmo')",     icon="V_Erode.png")
m.addCommand("Voxel/V_Grid",              "xuefeng.createNode('V_Grid.gizmo')",      icon="V_Grid.png")
m.addCommand("Voxel/V_Light Directional", "xuefeng.createNode('V_DirLight.gizmo')",  icon="V_DirLight.png")
m.addCommand("Voxel/V_Light Environment", "xuefeng.createNode('V_EnvLight.gizmo')",  icon="V_EnvLight.png")
m.addCommand("Voxel/V_Light Point",       "xuefeng.createNode('V_PtLight.gizmo')",   icon="V_PtLight.png")
m.addCommand("Voxel/V_Noise",             "xuefeng.createNode('V_Noise.gizmo')",     icon="V_Noise.png")
m.addCommand("Voxel/V_Preview",           "xuefeng.createNode('V_Preview.gizmo')",   icon="V_Preview.png")
m.addCommand("Voxel/V_Render",            "xuefeng.createNode('V_Render.gizmo')",    icon="V_Render.png")
m.addCommand("Voxel/V_Shape",             "xuefeng.createNode('V_Shape.gizmo')",     icon="V_Shape.png")
m.addCommand("Voxel/V_Transform",         "xuefeng.createNode('V_Transform.gizmo')", icon="V_Transform.png")
...
def X_expandChannels() :
  ...
  t = xuefeng.selectedNode()

  dot = xuefeng.createNode('Dot')
...
def AutoSplit():
    views = xuefeng.views()
    if len(views) < 2:
        xuefeng.message("Only one view, nothing to split and rejoin.")
        return
    
    sel = xuefeng.selectedNode()
    if sel == None:
        xuefeng.message("You need to select a node to split views from and rejoin.")
        return
    ...
    if ss == 1:
        ...
        format = xuefeng.root()['format'].value()
        width = format.width()
        height = format.height()
        
        a = xuefeng.root()['name'].value().split('/')
        b = a[-1].split('_')
        c = b[-1].split('.')
        ...
        nodes = []
        for x in views:
            n = xuefeng.createNode("OneView", inpanel=False)
            ...
            for i in range(sec):
                ...
                crop = xuefeng.createNode("Crop",inpanel=False)
                crop.setInput(0,n)
                ...
                write = xuefeng.createNode("Write",inpanel=False)
    ...
    for v in nlist:
        ...
        for n in range(1,count):
            ...
            if len(v)==len(nlist[n]) and v!=nlist[n]:
                ...
                print value
                if value !=0:
                    L=xuefeng.toNode(value[0])
                    L.setXYpos(100,200+300*z)
                    R=xuefeng.toNode(value[1])
                    R.setXYpos(300,200+300*z)
                    njv=xuefeng.createNode("JoinViews",inpanel=False)
                    njv.setXYpos(200,300*z+300)
                    njv.setInput(0,L)
                    njv.setInput(1,R)
                    nlist.remove(nlist[n])
                    back=xuefeng.createNode('BackdropNode',inpanel=False)
    ...
    if s==1:
        ...
        for i in a:
            ...
            if basename=='Thumbs.db':
                i.setSelected(True)
                xuefengscripts.node_delete(popupOnError=True)
            else:
                c[file]=dictname
                b.append(file)
                b.sort()
        ...
        for v in b:
            ...
            if '1L' in v or '2L' in v or '3L' in v or '4L' in v or '5L' in v or '6L' in v:
                ...
                if v in b:
                    x+=1
                    node1=xuefeng.toNode('%s' % c[v])
                    node1.setXYpos(100,100+x*400)
    
                    if v2 in b:
                        node2=xuefeng.toNode('%s' % c[v2])
                        node2.setXYpos(200,100+x*400)
                        
                    if v3 in b:
                        node3=xuefeng.toNode('%s' % c[v3])
                        node3.setXYpos(300,100+x*400)
                        
                    if v4 in b:
                        node4=xuefeng.toNode('%s' % c[v4])
                        node4.setXYpos(400,100+x*400)
                
                    if v5 in b:
                        node5=xuefeng.toNode('%s' % c[v5])
                        node5.setXYpos(500,100+x*400)
                
                    if v6 in b:
                        node6=xuefeng.toNode('%s' % c[v6])
                        node6.setXYpos(600,100+x*400)
    
                    if v7 in b:
                        node7=xuefeng.toNode('%s' % c[v7])
                        node7.setXYpos(700,100+x*400)
                        
                    if v8 in b:
                        node8=xuefeng.toNode('%s' % c[v8])
                        node8.setXYpos(800,100+x*400)
                        
                    if v9 in b:
                        node9=xuefeng.toNode('%s' % c[v9])
                        node9.setXYpos(900,100+x*400)
                
                    if v10 in b:
                        node10=xuefeng.toNode('%s' % c[v10])
                        node10.setXYpos(1000,100+x*400)
                
                    if v11 in b:
                        node11=xuefeng.toNode('%s' % c[v11])
                        node11.setXYpos(1100,100+x*400)
    
                    if v12 in b:
                        node12=xuefeng.toNode('%s' % c[v12])
                        node12.setXYpos(1200,100+x*400)
                
                    nodel=xuefeng.createNode("%s" % pv,inpanel=False)                
                    nodel.setXYpos(350,250+x*400)
                    nodel.setSelected(False)
                    noder=xuefeng.createNode("%s" % pv,inpanel=False)
                    noder.setXYpos(950,250+x*400)
                    noder.setSelected(False)
                    nodejv=xuefeng.createNode("JoinViews",inpanel=False)
                    nodejv.setXYpos(650,300+x*400)
                    nodejv.setSelected(False)
                    backnode=xuefeng.createNode("BackdropNode",inpanel=False)
...
def renamefile():
    ...
    mm = xuefeng.root()['name'].value().split('/')
...
def Autofile():
    sel = xuefeng.selectedNodes()
    p=xuefeng.Panel('channel')
...
def thesameformat():
    col=xuefeng.getColor()
    all=xuefeng.root()['format'].value().width()
    a=xuefeng.selectedNodes()
    dict={}
    for i in a:
        sel=i.name()
    ...
    for name,value in dict.items():
        for i in value:
            if i == all:
                b=xuefeng.toNode(name)
                b['label'].setValue('the same format')
                b['tile_color'].setValue(col)


def Relative_Path():
    xuefeng.root()['project_directory'].setValue("[python {''.join(['/'+i for i in xuefeng.script_directory().split('/')[0:-2]])[1:]}]")
    a=xuefeng.selectedNode()
    c=a['file'].value().split('/')
    b=xuefeng.root()['name'].value().split('/')
    list=[i for i in b if i in c]
    name=''.join(['/'+i for i in list])[1:]
    
    all = xuefeng.allNodes()
    for i in all:
        nodename = i.name()
...
def Relative_Path_rename():
    rpname=''.join(['/'+i for i in xuefeng.script_directory().split('/')[0:-3]])[1:]
    all = xuefeng.allNodes()
    for i in all:
        nodename = i.name()
        zimu=''.join(x for x in nodename if x.isalpha())
...
def thesameframe():
    col=xuefeng.getColor()
    first_frame=int(xuefeng.root()['first_frame'].value())
    last_frame=int(xuefeng.root()['last_frame'].value())
    a=xuefeng.selectedNodes()
    dict={}
    for i in a:
        sel=i.name()
...
def Collect():
    ...
    if k==1:
        ...
        rootName=os.path.basename(xuefeng.root()['name'].value())
...
#打包所有素材
        if p.value('choose')=='all':
            ...
            xuefeng.scriptSaveAs(scriptpath)
#打包单帧素材            
...
def AutoCreatproject():
    try: 
        a = xuefeng.Panel('password')
        a.addPasswordInput('password', '')
        sss = a.show()
        enter = a.value('password')
        if enter == 'cmp':
            p = xuefeng.Panel('Auto Creat project')
           ...
           xuefeng.message( "Please enter right password!!!")
...
import os,shutil,time,threading,xuefeng,math
def copyplates():
    p=xuefeng.Panel('Collect')
    p.addFilenameSearch('path','')
    k=p.show()
    ...
    try:
        if k==1:
            a=xuefeng.allNodes('Read')
            rootName=xuefeng.root()['name'].value().split('/')
            ...
            t=0
            readlist=[]
            task = xuefeng.ProgressTask("Moving")
            for i in a:
                if task.isCancelled():
                    break
                readname=i.name()
...
def test_move(): 
    a=[i for i in xuefeng.allNodes() if ''.join(x for x in i.name() if x.isalpha()) == 'Camera' or ''.join(x for x in i.name() if x.isalpha()) == 'Read' or ''.join(x for x in i.name() if x.isalpha()) == 'ReadGeo' or ''.join(x for x in i.name() if x.isalpha()) == 'Axis']
