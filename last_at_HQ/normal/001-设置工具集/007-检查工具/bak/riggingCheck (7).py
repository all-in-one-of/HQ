...
class CleanCheckRIG(QtGui.QDialog):
	...
	def __init__(self , parent = None):
		...
		self.checkBox_7 = QtGui.QCheckBox(unicode('设置geo组下模型可渲染' , 'gbk') , self.groupBox)
		self.checkBox_7.setGeometry(QtCore.QRect(10, 340, 211, 20))
	...
	def checkNodesMain(self , *args):
		...
		while True:
			...
			if self.checkBox_7.isChecked():
				self.addFrm(self.setGeoGroupRender , '5' , 'QlookLayout' , '设置geo组下模型可渲染：' , False , [0 , 0.5 , 0] )
