...
class CleanCheckRIG(QtGui.QDialog):
	...
	def __init__(self , parent = None):
		...
		self.line_4.setGeometry(QtCore.QRect(5, 340, 290, 16))
		self.line_4.setFrameShape(QtGui.QFrame.HLine)
		self.line_4.setFrameShadow(QtGui.QFrame.Sunken)
		
		self.checkBox_20 = QtGui.QCheckBox(unicode('全选/全不选' , 'gbk') ,self.groupBox)
		self.checkBox_20.setGeometry(QtCore.QRect(10, 355, 91, 20))
		
		self.pushButton = QtGui.QPushButton(unicode('开始检查' , 'gbk') ,self.groupBox)
		self.pushButton.setGeometry(QtCore.QRect(10, 380, 280, 25))
		
		
		self.resize(310, 430)
		
		self.setMinimumSize(QtCore.QSize(310, 430))
		self.setMaximumSize(QtCore.QSize(310, 430))
	...
	def checkMainCtrl(self):
		...
		if not pm.objExists(ctrlName):
			OpenMaya.MGlobal_displayWarning('没有总控制器 {0:s}'.format(ctrlName)) 
			return None
