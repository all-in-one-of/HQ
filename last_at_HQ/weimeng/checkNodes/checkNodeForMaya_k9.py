...
class checkNodes(Ui_checkNodesWindow,QtCore.QObject):
    ...
    def __init__(self,checkNodesWidget):
        ...
        for i in range(len(self.buttonList)):
            ...
            bt.setStyleSheet("height:20px;border-style:inset;border-width:1px;border-color: QLinearGradient(x1:0, y1:0, x2:0, y2:1, stop:0 #616161, stop:0.5 #616161 stop:1 #616161);font-size: 12px;text-align: left;font-weight:900;\n"
            "")
    ...
    def __init__(self,k_Treturn):
        ...
        for k_reply in self.k_reply:
            if k_Treturn[k_reply]:
                ...
                #self.addTabwidget.itemEntered.connect(self.listItemSelect)
