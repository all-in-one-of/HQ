...
# DESCRIPTION: 
#     This script will...
#         - bake a maya or mental ray shader to texture file
#
# INSTALLATION:
...
#load only nurbs or mesh if not already loaded
    ...
    if len(selection)==0:
        ...
        if classification[0] == 'drawdb/shader/texture/2d/ramp:texture/2d' or \
                classification[0] == 'drawdb/shader/surface/lambert:shader/surface' or \
                classification[0] == 'shader/surface' or \
                classification[0] == 'shader/surface/utility' or \
                classification[0] == 'utility/color' or \
                classification[0] == 'utility/general' or \
                classification[0] == 'connection/mentalray/shadow:rendernode/mentalray/material:shader/surface:swatch/mentalRaySwatchGen'  or \
                classification[0] == 'connection/mentalray/photon:connection/mentalray/shadow:rendernode/mentalray/material:shader/surface:swatch/mentalRaySwatchGen':
...
def bakeTextureSequence():
    '''{'del_path':'Rendering/Render/bakeTextureSequence()',
'usage':'bakeTextureSequence()',
}
'''
