...
###### WRITE ########################################################################
    ...
    def bgeoConvert(self, geo, convert):
        bgeo = geo.replace('.geo','.bgeo')
