...
cmds.setAttr(fluidShape+".transparency", 0.649999976158, 0.649999976158, 0.649999976158, type="float3")
...
cmds.setAttr(fluidShape+".opacityInputBias", 0.159999996424)
...
cmds.setAttr(fluidShape+".opacity[1].opacity_Position", 0.569999992847)
cmds.setAttr(fluidShape+".opacity[1].opacity_FloatValue", 0.0)
cmds.setAttr(fluidShape+".opacity[1].opacity_Interp", 1)
cmds.setAttr(fluidShape+".opacity[2].opacity_Position", 0.649999976158)
cmds.setAttr(fluidShape+".opacity[2].opacity_FloatValue", 0.0250000003725)
cmds.setAttr(fluidShape+".opacity[2].opacity_Interp", 1)
cmds.setAttr(fluidShape+".opacity[3].opacity_Position", 0.694999992847)
cmds.setAttr(fluidShape+".opacity[3].opacity_FloatValue", 0.34999999404)
cmds.setAttr(fluidShape+".opacity[3].opacity_Interp", 1)
cmds.setAttr(fluidShape+".opacity[5].opacity_Position", 0.740000009537)
cmds.setAttr(fluidShape+".opacity[5].opacity_FloatValue", 0.550000011921)
cmds.setAttr(fluidShape+".opacity[5].opacity_Interp", 1)
cmds.setAttr(fluidShape+".opacity[6].opacity_Position", 0.839999973774)
cmds.setAttr(fluidShape+".opacity[6].opacity_FloatValue", 0.675000011921)
cmds.setAttr(fluidShape+".opacity[6].opacity_Interp", 1)
cmds.setAttr(fluidShape+".opacity[7].opacity_Position", 1.0)
cmds.setAttr(fluidShape+".opacity[7].opacity_FloatValue", 0.75)
